(function () {
  ...
  var translations = {
    id: {
      ...
      flexibleTransactionText: "Dengan GoePOS, kasir bisa menangani pembayaran campuran, memisahkan menu sesuai pelanggan, dan menahan transaksi sementara saat pelanggan belum siap membayar. Semua dibuat agar pelayanan tetap lancar, antrean tidak berhenti, dan kasir tidak perlu menghitung manual.",
      spotlightBack: "Tutup",
