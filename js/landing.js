(function () {
  ...
  var translations = {
    id: {
      ...
      spotlightEyebrow: "Cepat & Tidak Ribet",
      spotlightTitle: "",
      spotlightLead: "",
      spotlightPayKicker: "",
      ...
      spotlightLensKicker: "",
      spotlightLensTitle: "Fleksibilitas Transaksi",
      spotlightLensText: "Split pembayaran, split menu, atau tahan transaksi dengan lebih mudah.",
      spotlightBack: "Tutup",
      ...
      spotlightLensDetailText: "Uang pelanggan kurang? ingin bayar patungan sesuai pesanan? ingin tunda pembayaran sebentar? Dengan GoePOS, kasir bisa split pembayaran, split menu, dan hold transaksi dengan mudah, tanpa membuat antrean berhenti",
      spotlightLensPoint1: "",
      spotlightLensPoint2: "",
      spotlightLensPoint3: "",
      ...
      pricingEyebrow: "Harga sederhana",
    ...
    en: {
      ...
      spotlightLensKicker: "",
      spotlightLensTitle: "Transaction Flexibility",
      spotlightLensText: "Split payments, split menu items, or hold transactions more easily.",
      spotlightBack: "Close",
      spotlightPayDetailTitle: "",
      ...
      spotlightPayPoint3: "",
      spotlightLensDetailTitle: "",
      spotlightLensDetailText: "Customer short on cash? Want to split payment based on each order? Need to hold payment for a moment? With GoePOS, cashiers can split payments, split menu items, and hold transactions easily without stopping the queue.",
      spotlightLensPoint1: "",
      spotlightLensPoint2: "",
      spotlightLensPoint3: "",
